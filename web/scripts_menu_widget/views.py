...
# scripts_menu_widget
@login_required()
def iframe_content_view(request, **kwargs):
    """
    View function to render and serve the iframe_content.html template.
    """
    return render(request, 'webclient/base/includes/iframe_content.html')